import resume from '../img/shellytan_resume.pdf';
...
function About() {
  return (
    <div className="wrapper about">
        ...
        <p className="body">Currently open to new opportunities. For a printable version of my résumé, click <a href={resume} target="_blank" rel="noopener noreferrer">here</a>.</p>
