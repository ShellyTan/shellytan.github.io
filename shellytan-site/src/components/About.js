function About() {
  return (
    <div className="wrapper about">
        ...
        <p className="body">I'm currently open to new opportunities. For a printable version of my résumé, click <a href="shellytan_resume.pdf" target="_blank">here</a>.</p>
